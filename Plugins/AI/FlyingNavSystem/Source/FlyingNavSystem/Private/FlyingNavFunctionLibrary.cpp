	...
	const TSubclassOf<UNavigationQueryFilter> FilterClass)
{
	...
	else
	{
		...
		{
			printw(
				"WARNING: NavSys->GetDefaultNavDataInstance() == nullptr. Check a valid default agent is set in Project Settings and a Nav Mesh Bounds Volume is present in the level.")
		}
